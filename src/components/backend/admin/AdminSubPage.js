            ...
            <div class="mt-7 border border-gray-300 pt-9">
                <div class="flex max-md:flex-col items-center justify-between px-3 md:px-11">
                    <div class="data">
                        ...
                        <p class="font-medium text-lg leading-8 text-black mt-3 whitespace-nowrap"><b>Name:</b>{data.orderuserdetails.firstName} LastName:{data.orderuserdetails.lastName} <br/>email:{data.orderuserdetails.email} Number:{data.orderuserdetails.phone} <br/>address:{data.orderuserdetails.street} city:{data.orderuserdetails.city} <br/>state:{data.orderuserdetails.state} zipCode:{data.orderuserdetails.zipCode} delivery:{data.orderuserdetails.cash}</p>
                    </div>
